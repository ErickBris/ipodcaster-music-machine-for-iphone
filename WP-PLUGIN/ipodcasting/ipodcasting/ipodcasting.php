...
/*
Plugin Name: iPodcast by studio76 - shared on codelist.cc
Version: 1.1
Plugin URI: http://studio76.ru/
Description: Podcasting plugin for iPodcast app Iphone.
Author: Studio76.RU
Author URI: http://studio76.ru/
*/

define('iPODCASTING_VER', '1.1');
...
add_action('activate_podcasting/ipodcasting.php', 'podcasting_install');

# Include the admin CSS
add_action('admin_head', 'podcasting_css');

# Include the settings information
include_once('ipodcasting-settings.php');

# Include the metabox
include_once('ipodcasting-metabox.php');

# Include the feed
include_once('ipodcasting-feed.php');

# Include the player
include_once('ipodcasting-player.php');

# Include the podPress importer
include_once('ipodpress-importer.php');
...
function pod_filter_plugin_actions($links) {
	...
	$new_links[] = '<a href="options-general.php?page=ipodcasting-settings.php">Settings</a>';
...
function pod_filter_plugin_links($links, $file)
{
	...
	{
		$links[] = '<a href="http://studio76.ru/">Studio76.ru</a>';
