...
/**
 * podPress importer for iPodcast
 * @author studio76.ru
 **/
class PodcastingSettings
{
	...
	function addPodcastingSettingsPage() {
		...
		add_options_page('iPodcasting Settings', 'iPodcasting', 8, basename(__FILE__), array($this, 'addSettings'));
	}
	...
	function addSettings() {
		...
		<h2>iPodcasting Settings</h2>
			
		<form method="post" action="options-general.php?page=ipodcasting-settings.php">
		<?php $this->nonceField(); ?>
			<p><em>
				iPodcast for App.
        Visit <a href="http://studio76.ru/">Studio76.ru</a>.
			</em></p>
			<table class="form-table">
				<tr valign="top">
					<th scope="row" style="width: 200px;">
						<label>iPodcast feed address (URL):</label>
					</th>
					<td>
